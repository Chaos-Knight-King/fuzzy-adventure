...
function gotPoses(results)
{
  try{
    ...
    leftWristY = results[0].pose.leftWristY.y;
		console.log("rightWristX = " + rightWristX+", rightWrist Y = " + noseY + "leftWristX = " + leftWristX + "leftWristY = "+ leftWristY);
	
  
  }
}
  catch(err) {
    console.log("Debug @gotPoses line 20 - 33");
  }
}
